var XHR,clayPay;(function(n){function u(n){var t=new r;return t.Headers=n.getAllResponseHeaders(),t.Text=n.responseText,t.Type=n.responseType,t.Status=n.status,t.StatusText=n.statusText,t}function t(n,t,i,r){return r===void 0&&(r=""),new Promise(function(f,e){var o=new XMLHttpRequest;o.open(n,t);i!=null&&i.forEach(function(n){return o.setRequestHeader(n.header,n.data)});o.onload=function(){(o.status<200||o.status>=300)&&e(u(o));f(u(o))};o.onerror=function(){e("There was an error communicating with the server.  Please check your connection and try again.")};r.length>0?o.send(r):o.send()})}function i(t){return t===null||t.length==0?t=[new n.Header("Content-Type","application/json; charset=utf-8"),new n.Header("Accept","application/json")]:(t.push(new n.Header("Content-Type","application/json; charset=utf-8")),t.push(new n.Header("Accept","application/json"))),t}function e(n,r,u){return r===void 0&&(r=null),u===void 0&&(u=!0),r=u?i(r):r,t("GET",n,r)}function o(n,r,u,f){return r===void 0&&(r=""),u===void 0&&(u=null),f===void 0&&(f=!0),u=f?i(u):u,t("POST",n,u,r)}function s(n,r,u,f){return r===void 0&&(r=""),u===void 0&&(u=null),f===void 0&&(f=!0),u=f?i(u):u,t("PUT",n,u,r)}function h(n,r,u,f){return r===void 0&&(r=""),u===void 0&&(u=null),f===void 0&&(f=!0),u=f?i(u):u,t("DELETE",n,u,r)}function c(t,i){i===void 0&&(i="");var r=n.Get(t+i);return new Promise(function(n,i){r.then(function(t){var i=JSON.parse(t.Text);n(i)}).catch(function(){console.log("error in Get "+t);i(null)})})}function l(t,i){i===void 0&&(i="");var r=n.Get(t+i);return new Promise(function(n,i){r.then(function(t){var i=JSON.parse(t.Text);n(i)}).catch(function(){console.log("error in Get "+t);i(null)})})}function a(t,i){var r=n.Post(t,JSON.stringify(i));return new Promise(function(n,i){r.then(function(t){if(t.Text.length===0)n([]);else{var i=JSON.parse(t.Text);n(i)}}).catch(function(n){console.log("save object error "+t+" "+n);i(null)})})}var f=function(){function n(n,t){this.header=n;this.data=t}return n}(),r;n.Header=f;r=function(){function n(){}return n}();n.Data=r;n.Get=e;n.Post=o;n.Put=s;n.Delete=h;n.GetArray=c;n.GetObject=l;n.SaveObject=a})(XHR||(XHR={}));
/*!
